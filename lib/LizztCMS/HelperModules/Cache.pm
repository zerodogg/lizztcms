...
# LizztCMS::HelperModules::Cache
package LizztCMS::HelperModules::Cache;
use strict;
use warnings;
...
LizztCMS::HelperModules::Cache - Cache helper functions for LizztCMS

=head1 DESCRIPTION

This module provides a single function, as well as three constants
that can assist with caching within LizztCMS.
...
Any of the arguments can be undef, and lizztcms will just default them,
