...
package LizztCMS::HelperModules::List;

use Moose;
use List::MoreUtils qw(any);
use LizztCMS::HelperModules::JSON qw(json_response);
use LizztCMS::HelperModules::Forms qw(finalize_form);
use LizztCMS::HelperModules::Search qw(cross parse_search_string);
use Try::Tiny;
...
sub listFolderFilter
{
    ...
    my $fobj = $self->c->model('LizztCMSDB::LzFolder')->find({folder_id => $folder });
