...
#
# Some gotchas:
# Instead of $c->model('LizztCMSDB::...')->create({}); use
# $c->model('LizztCMSDB::...')->new_result({});
#
...
package LizztCMS::HelperModules::RevisionControl::Article;
use Moose;
use Carp qw(croak);
use 5.010;
use Try::Tiny;
extends 'LizztCMS::HelperModules::RevisionControl';
...
sub set_root 
{
    ...
    if(!$article->isa('LizztCMS::Model::LizztCMSDB::LzArticle') && !$article->isa('LizztCMS::Schema::LzArticle'))
    {
