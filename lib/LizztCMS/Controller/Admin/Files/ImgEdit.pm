...
package LizztCMS::Controller::Admin::Files::ImgEdit;
...
use LizztCMS::HelperModules::Includes qw(add_jsIncl add_cssIncl add_jsOnLoad add_bodyClass add_CDNload);
use Graphics::Magick;
use LizztCMS::HelperModules::Files qw(lizztcms_serve_scalar_file);
...
sub resizer : Local Args
{
    ...
    lizztcms_serve_scalar_file($c, $blob,$file->get_mimetype($c));
}
...
sub saveCrop : Local
{
    ...
    {
        $c->model('LizztCMSDB::LzFieldValue')->create({
