package LizztCMS::Schema::LzWorkflow;
...
__PACKAGE__->belongs_to('article' => 'LizztCMS::Schema::LzArticle',{ 'foreign.article_id' => 'self.article_id', 'foreign.revision' => 'self.revision' });
__PACKAGE__->belongs_to('role' => 'LizztCMS::Schema::LzRole',{'foreign.role_id' => 'self.assigned_to_role'});
__PACKAGE__->belongs_to('user' => 'LizztCMS::Schema::LzUser',{'foreign.user_id' => 'self.assigned_to_user'});
__PACKAGE__->belongs_to('assigned_by_user' => 'LizztCMS::Schema::LzUser', { 'foreign.user_id' => 'self.assigned_by' });
__PACKAGE__->has_many('comments' => 'LizztCMS::Schema::LzWorkflowComments',{
