package LizztCMS::Schema::LzNewsletterSubscription;
...
LizztCMS::Schema::LzNewsletterSubscription
...
use LizztCMS::HelperModules::EMail qw(send_raw_email_to);
use LizztCMS::HelperModules::Calendar qw(datetime_from_SQL datetime_from_unix datetime_to_SQL);
use HTML::Entities qw(decode_entities);
use LizztCMS::HelperModules::Text qw(sanitizeStringLength);
...
__PACKAGE__->has_many('categories' => 'LizztCMS::Schema::LzNewsletterSubscriptionCategory', 'subscription_id');
__PACKAGE__->has_many('groups' => 'LizztCMS::Schema::LzNewsletterSubscriptionGroup', 'subscription_id');
...
sub subscribeToCategories
{
    ...
    foreach my $catId (@_)
    {
        if ($c->model('LizztCMSDB::LzCategory')->find({category_id => $catId}))
        {
            $c->model('LizztCMSDB::LzNewsletterSubscriptionCategory')->create({
