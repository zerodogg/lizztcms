package LizztCMS::Schema::LzRssArticle;
...
use LizztCMS::HelperModules::Calendar qw(datetime_from_SQL);
...
sub shorttitle { return LizztCMS::Schema::LzArticle::shorttitle(@_); }
