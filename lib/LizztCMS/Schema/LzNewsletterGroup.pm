package LizztCMS::Schema::LzNewsletterGroup;
...
LizztCMS::Schema::LzNewsletterGroup
...
__PACKAGE__->has_many('subscriptions' => 'LizztCMS::Schema::LzNewsletterSubscriptionGroup','group_id');
