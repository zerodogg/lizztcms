package LizztCMS::Schema::LzField;
...
__PACKAGE__->has_many('modules' => 'LizztCMS::Schema::LzFieldModule','field_id');
__PACKAGE__->has_many('values' => 'LizztCMS::Schema::LzFieldValue','field_id');
__PACKAGE__->has_many('options' => 'LizztCMS::Schema::LzFieldOptions','field_id');
1;
