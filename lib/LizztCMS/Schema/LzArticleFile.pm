package LizztCMS::Schema::LzArticleFile;
...
__PACKAGE__->belongs_to('file' => 'LizztCMS::Schema::LzFile', 'file_id');
...
sub autoAssignToSpot
{
    ...
    {
        my $existing = $c->model('LizztCMSDB::LzArticleFile')->search({
