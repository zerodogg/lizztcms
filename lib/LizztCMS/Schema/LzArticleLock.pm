package LizztCMS::Schema::LzArticleLock;
...
#__PACKAGE__->belongs_to('article' => 'LizztCMS::Schema::LzArticle','article_id');
__PACKAGE__->belongs_to('user' => 'LizztCMS::Schema::LzUser','locked_by_user');
