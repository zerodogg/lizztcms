package LizztCMS::Schema::LzFieldValue;
...
__PACKAGE__->belongs_to('field' => 'LizztCMS::Schema::LzField','field_id');
__PACKAGE__->might_have('article' => 'LizztCMS::Schema::LzArticle',
    {
