package LizztCMS::Schema::LzTemplate;
...
use LizztCMS::HelperModules::Templates qw(get_parsed_template_info);

sub path_to_template_file
{
    my($self,$c) = @_;
    return $c->config->{LizztCMS}->{template_path}.'/'.$self->file;
}
