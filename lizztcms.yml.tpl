...
# -- Don't use this file to create your initial config file. Use ./scripts/lizztcms_install.pl --
...
# Session storage location, path to a file where temporary LizztCMS session
# information will be stored
session:
    storage: [SESSION_STORAGE]

# LizztCMS memcached configuration
Plugin::Cache:
    backend:
        # Memcached server addresses
        servers:
            - [MEMCACHED_SERVER]
        # The memcached namespace, needs to be unique to this instance of LizztCMS
        # to avoid collisions when sharing a server with other LizztCMS instances
        namespace: [MEMCACHED_NAMESPACE]
# LizztCMS template directories
View::Mason:
    ...
    comp_root:
        -
            - root
            # Path to the root/ directory in the LizztCMS tree
            - [LizztCMS_ROOT]
        -
            - templates
...
LizztCMS:
    # Temporary LizztCMS files
    temp_path: [TMP_PATH]
    # User uploaded files
    file_path: [FILE_PATH]
    # User uploaded templates
    template_path: [TEMPLATE_PATH]
    # The default 'From' e-mail used in LizztCMS
    ...
    # If you want LizztCMS to log errors from the client code (javascript), set this
    # to 1
    clientErrorLog: [CLIENT_ERROR_LOG]
    # If you want LizztCMS to log to a file instead of outputting to STDERR (ie. to
    # get LizztCMS logs separate from Apache/Nginx logs), set this option to
